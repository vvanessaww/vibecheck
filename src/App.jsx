...
function App() {
  ...
  const renderScreen = () => {
    switch (quiz.currentScreen) {
      case SCREENS.START:
        return <StartScreen onStart={() => { if (muted) toggleAudio(); quiz.nextScreen(); }} playerName={quiz.playerName} onNameChange={quiz.setPlayerName} challengerName={quiz.challenger?.name} />;
